    ...
    <div className='register-page'>
      ...
      <div className='register-right'>
        <div className="register-right-content">
          ...
          <div className="title">
            <h1>Créez un compte d'enseignant</h1>
          ...
          <form>
            ...
            <div className="form-groups">
              ...
              <div className="form-group">
                <input type="text" name='bio' onChange={e => setBio(e.target.value)} placeholder='Entrez votre matière' />
                <label htmlFor="bio">Matiere</label>
              </div>
            </div>
            <div className="form-group">
